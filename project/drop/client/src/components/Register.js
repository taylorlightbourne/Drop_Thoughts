        ...
        <div className="main-contents">
            ...
            <form onSubmit={signUp}>
                <div>
                    ...
                    <input type="text" name="username" id="floatingInput" onChange={(e) => setUserFormData({...userFormData,
                [e.target.name]: e.target.value,
            }) } required></input>
                </div>
                <div>
                    <label><b>Password: </b></label>
                    <input type="password" name="password" id="floatingInput" onChange={(e) => setUserFormData({...userFormData,[e.target.name]: e.target.value,
            }) } required></input>
                </div>
                <div>
